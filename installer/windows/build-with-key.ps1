...
# Removes the build, dist and output folders
Remove-Item build -r
Remove-Item dist -r 
...
Copy-Item ..\..\cgpt\config.ini.bak .\dist\config.ini

# Builds the installer
& 'C:\Program Files (x86)\Inno Setup 6\ISCC.exe' cgpt-installer-with-key.iss    
